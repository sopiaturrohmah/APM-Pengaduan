...
<html lang="en">
  <head>
	...
	<body class="img js-fullheight" style="background-image: url(/images/Padarek.jpg);">
	<section class="ftco-section">
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-md-6 text-center mb-5">
					<h2 class="heading-section">Selamat Datang Di Aplikasi Pengaduan Masyarakat Desa Padarek</h2>
				</div>
			</div>
			<div class="row justify-content-center">
